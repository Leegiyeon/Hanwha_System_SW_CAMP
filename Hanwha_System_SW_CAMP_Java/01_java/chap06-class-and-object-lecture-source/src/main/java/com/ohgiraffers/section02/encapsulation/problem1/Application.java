...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        monster1.name = "두치";       // 참조연산자를 통해 값 대입
        monster1.hp = 200;
        ...
        monster2.name = "뿌꾸";       // 참조연산자를 통해 값 대입
        monster2.hp = -200;
        ...
        monster3.name = "드라큘라";       // 참조연산자를 통해 값 대입
        monster3.sethp(100);            // monster3d의 hp공간에 100이 할당됨
        ...
        monster4.name = "프랑켄슈타인";       // 참조연산자를 통해 값 대입
        monster4.sethp(-100);            // monster3d의 hp공간에 100이 할당됨

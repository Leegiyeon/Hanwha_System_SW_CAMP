...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        /* 설명. 기본자료형을 Wrapper클래스 자료형으로 반환할 수 있다.(박싱) */
        Integer boxingInt = (Integer)20;
        Integer boxingInt2 = Integer.valueOf(intValue);
    
        
        /* 설명. Wrapper클래스 자료형을 기본자료형으로 반환할 수 있다.(언박싱)  */
        int unBoxingValue = boxingInt.intValue();

        /* 설명. 기본자료형과  Wrapper클래스는 자동으로 박싱 및 언박싱이 일어난다. */
        Integer autoBoxingInt = intValue;
        int autoUnBoxingValue = autoBoxingInt;

        anythingMethod(10);     // Object obj = (Object)(Integer) 10


        /* 설명. Wrapper클래스 값 비교 */
        /* 설명.  Wrapper클래스들도 리터럴 값으로 오토박싱하면 결국 동일한 객체하나만 관리한다. */
    ...
    /* 설명. 매개변수가 Object인 메소드(어떤 자료형도 전달인자로 받을 수 있음) */
    public static void anythingMethod(Object obj){ // 10 -> Integer(Auto boxing) -> Object(다형성)
        System.out.println("obj: "+ obj);       // Memo. Object의 toString()이 아닌 Integer의 toString()이 실행 됨(동적 바인딩)
    }
}

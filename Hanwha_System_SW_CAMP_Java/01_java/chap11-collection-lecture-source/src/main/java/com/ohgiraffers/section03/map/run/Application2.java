...
public class Application2 {
    public static void main(String[] args) {
        ...
        /* 필기.
         *  Properties란?
         *  HashMap과 거의 유사하지만 key와 value 모두를 String으로만 사용할 수 있는 자료구조 있다.
        ...
        * */
        ...
        try {
            ...
            prop.store(new FileOutputStream("driver.txt"), "jdbc driver2");
            prop.storeToXML(new FileOutputStream("driver.xml"), "jdbc driver3");
        } catch (IOException e) {
            throw new RuntimeException(e);
        }

        /* 설명. 저장한 파일에서부너 읽어온 데이터를 담을 Properties 객체 */
        Properties prop2 = new Properties();

        System.out.println("파일 읽어오기 전: " + prop2);
        try {

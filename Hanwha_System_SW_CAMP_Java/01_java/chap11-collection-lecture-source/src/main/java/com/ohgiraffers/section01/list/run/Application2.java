...
public class Application2 {
    public static void main(String[] args) {
        ...
        /* 수업목표. ArrayList에서 관리되는 자료의 정렬기준을 이용할 수 있다. */
...
//        }
        ...
        // Memo. 가격(price)의 오름차순
        /* 설명. Collections가 제공하는 sort 사용 시*/
//        Collections.sort(bookList);                             // Memo. Comparable
//        Collections.sort(bookList, new AscendingPrice());       // Memo. Comparator(권한이 더 높음)
        Collections.sort(bookList, new DescendingAuthor());

        /* 설명. ArrayList가 제공하는 sort 사용 시 */

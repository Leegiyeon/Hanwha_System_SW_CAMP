...
//        ArrayList <Objects> aList = new ArrayList<Objects>();     // 다이아몬드 연산자 없는 제네릭 클래스는 Object와 같다.
...
//        Collection col = new ArrayList();
        ...
        System.out.println("aList의 첫번째 값: " + aList.get(0));
        System.out.println("aList의 두번째 값: " + aList.get(1));
        System.out.println("aList의 크기: " + aList.size());         // 우리가 aList에 추가한 값의 크기
        ...
        /* 설명. 배열과 ArrayList를 활용해 각각 원하는 인덱스에 값 추가하기 */
        ...
        /* 설명. ArrayList에서 제공하는 add메소드로 쉽게해보자 */
        ...
        /* 설명. set() 메소드로 원하는 인덱스 값을 원하는 값으로 수정할 수 있다. */
        aList.set(1, 777);
        System.out.println(aList);

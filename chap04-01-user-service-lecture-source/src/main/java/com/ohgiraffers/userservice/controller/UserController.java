...
public class UserController {
    ...
    /* 설명.
    *   application.yml 파일로부터 설정 값을 불러오기 위해 필요한 두가지 방법
    *   1. Environment: 의존성 주입을 받아 getProperty로 설정 키 값을 작성
    *   2. @Value: 필드로 주입받아 활용
    *  */

    /* 설명. 1. Environment: 의존성 주입을 받아 getProperty로 설정 키 값을 작성 */
